...
class CEOCompletedTicketListPage extends StatefulWidget {
  @override
  _MyCEOCompletedTicketListPageState createState() =>
      _MyCEOCompletedTicketListPageState();
}

class _MyCEOCompletedTicketListPageState
    extends State<CEOCompletedTicketListPage> {
  List<int> resource;

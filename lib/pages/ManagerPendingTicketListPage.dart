...
class ManagerPendingTicketListPage extends StatefulWidget {
  @override
  _MyManagerPendingTicketListPageState createState() =>
      _MyManagerPendingTicketListPageState();
}

class _MyManagerPendingTicketListPageState
    extends State<ManagerPendingTicketListPage> {
  List<int> resource;

...
class FinancePendingTicketListPage extends StatefulWidget {
  @override
  _MyFinancePendingTicketListPageState createState() =>
      _MyFinancePendingTicketListPageState();
}

class _MyFinancePendingTicketListPageState
    extends State<FinancePendingTicketListPage> {
  List<int> resource;
